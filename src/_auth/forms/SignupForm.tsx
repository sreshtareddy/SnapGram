...
const SignupForm = () => {
  ...
  //1. Define your form and it is coming from lib/validation formsSchema
  ...
  return (
      ...
      <div className="sm:w-420 flex-center flex-col"> 
          ...
          <p className="text-light-4 small-medium md:base-regular mt-2"> To use Snapgram please enter your details</p>
